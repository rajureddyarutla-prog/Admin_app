...
export interface ApiCompanyPageCompanyPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    profile_rows: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    tag_pill: Schema.Attribute.String;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiContactPageContactPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    enquiry_areas: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiInvestorsPageInvestorsPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    tag_pill: Schema.Attribute.String;
    title: Schema.Attribute.String;
    trl_levels: Schema.Attribute.JSON;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiNavigationNavigation extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    cta_href: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'https://pawos.app'>;
    cta_text: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Access PawOS'>;
    ...
    logo_text_top: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Mattera'>;
    nav_links: Schema.Attribute.JSON;
    notification: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Create arbitrary pages from the CMS';
...
export interface ApiPlatformPagePlatformPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    pawos_features: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiResearchCollaborationPageResearchCollaborationPage
  extends Struct.SingleTypeSchema {
  collectionName: 'research_collaboration_pages';
  info: {
    displayName: 'Research Collaboration Page';
    pluralName: 'research-collaboration-pages';
    singularName: 'research-collaboration-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    grant_areas: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    validation_pathways: Schema.Attribute.JSON;
  };
}
...
export interface ApiResearchStudyResearchStudy
  extends Struct.CollectionTypeSchema {
  collectionName: 'research_studies';
  info: {
    displayName: 'Research Study';
    pluralName: 'research-studies';
    singularName: 'research-study';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    display_id: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiTechPillarTechPillar extends Struct.CollectionTypeSchema {
  collectionName: 'tech_pillars';
  info: {
    displayName: 'Tech Pillar';
    pluralName: 'tech-pillars';
    singularName: 'tech-pillar';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiTechnologyPageTechnologyPage
  ...
  attributes: {
    architecture_steps: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cta_section: Schema.Attribute.JSON;
    ...
    publishedAt: Schema.Attribute.DateTime;
    tag_pill: Schema.Attribute.String;
    tech_layers: Schema.Attribute.JSON;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::research-collaboration-page.research-collaboration-page': ApiResearchCollaborationPageResearchCollaborationPage;
      'api::research-page.research-page': ApiResearchPageResearchPage;
      'api::research-study.research-study': ApiResearchStudyResearchStudy;
      'api::tech-pillar.tech-pillar': ApiTechPillarTechPillar;
